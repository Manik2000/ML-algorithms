...
class Layer:
    ...
    def __init__(self, input_size, output_size, activation):
        ...
        self.weights = np.random.uniform(-1 / np.sqrt(input_size), 1 / np.sqrt(input_size), size=(output_size, input_size))
        self.bias = np.random.uniform(-1 / np.sqrt(input_size), 1 / np.sqrt(input_size), size=(output_size, 1))
